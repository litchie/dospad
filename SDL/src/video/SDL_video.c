...
#if 0
    {
        float sx = window->w/(float)texture->w;
        float sy = window->h/(float)texture->h;
        real_dstrect.x = dstrect->x * sx;
        real_dstrect.y = dstrect->y * sy;
        real_dstrect.w = dstrect->w * sx;
        real_dstrect.h = dstrect->h * sy;
    }
#else
    real_dstrect.x = 0;
    real_dstrect.y = 0;
